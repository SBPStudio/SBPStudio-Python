# examples/run_demos.ps1 — Test runner for sbp_studio (PowerShell)
#
# Run from the REPO ROOT with the conda env active:
#   conda activate sbp_studio
#   cd T:\workspace_py\SBP-Studio
...
if ($Solo -in @("todo","real")) {
    ...
    python -m sbp_studio.cli.main info @ALL

    titulo "REAL 2 — Info: JSON output"
    python -m sbp_studio.cli.main info --json @ALL
    ...
    python -m sbp_studio.cli.main export-image @ALL `
    ...
    python -m sbp_studio.cli.main navline @ALL `
